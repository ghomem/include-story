This is an experiment on one page responsive websites and HTML includes.

Sources:

* https://html5up.net/ (base structure)
* https://github.com/Paul-Browne/HTMLInclude (assets/js/HTMLInclude)

Note:

Local testing with Firefox requires the privacy.file_unique_origin preference set to False.

Original HTML5UP README below.
